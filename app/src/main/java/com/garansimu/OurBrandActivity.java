...
public class OurBrandActivity extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener {
    private Typeface fontUbuntuL, fontUbuntuB;
    private TextView txtTitle, txtBack, lblSearch;
    ...
    private ImageView imgEditLeft, imgConfirmation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_our_brand);
        ...
        imgConfirmation = (ImageView) findViewById(R.id.imgConfirmation);
        ...
        lblSearch.setTypeface(fontUbuntuL, Typeface.BOLD);

        pDialog = new ProgressDialog(OurBrandActivity.this);
        ...
        spinCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                //getOurBrand(spinCategory.getSelectedItem().toString());
            }
            @Override
        ...
        Kategori catAll = new Kategori(0, "All", "");
        categoriList.add(catAll);
        populateSpinnerCategori();

        imgConfirmation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OurBrandActivity.this, ConfirmationActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    private void populateSpinnerCategori() {
        ...
        ourBrandAdapter = new OurBrandAdapter(OurBrandActivity.this, null);
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.getJSONArray("categories").length()!=0) {
                        ourBrandAdapter = new OurBrandAdapter(OurBrandActivity.this, response.getJSONArray("categories"));
                        itemList.setAdapter(ourBrandAdapter);
                    } else {
                        JSONArray jsonArray = new JSONArray();
                        ourBrandAdapter = new OurBrandAdapter(OurBrandActivity.this, jsonArray);
                        itemList.setAdapter(ourBrandAdapter);
                        Toast.makeText(OurBrandActivity.this, "No Our Brand", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
