...
public class MetodePembayaranActivity extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinOne       = (Spinner) findViewById(R.id.spinOne);
        ...
        pDialog = new ProgressDialog(MetodePembayaranActivity.this);
        ...
        Kategori catAll = new Kategori(0, "- Please Select -", "");
    ...
    private void populateSpinnerCategori() {
        ...
        spinOne.setAdapter(dataAdapter);
    }
            ...
            public void onResponse(JSONObject response) {
                try {
                    if (response.getJSONArray("categories").length()!=0) {
                        ourBrandAdapter = new OurBrandAdapter(MetodePembayaranActivity.this, response.getJSONArray("categories"));
                        itemList.setAdapter(ourBrandAdapter);
                    } else {
                        JSONArray jsonArray = new JSONArray();
                        ourBrandAdapter = new OurBrandAdapter(MetodePembayaranActivity.this, jsonArray);
                        itemList.setAdapter(ourBrandAdapter);
                        Toast.makeText(MetodePembayaranActivity.this, "No Our Brand", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
    ...
    public void btnConfirmationClicked(View view) {
