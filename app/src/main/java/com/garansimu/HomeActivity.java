...
public class HomeActivity extends Activity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private LinearLayout linMyProduct, linOurBrand, linContactUs, linRegisterAsPrinciple, linLogOut, linMyProfile, linUpgradeToSubscribe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        linOurBrand.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, OurBrandActivity.class);
                startActivity(intent);
            }
        });
        ...
        linRegisterAsPrinciple.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, RegisterAsBrandPrincipalActivity.class);
                startActivity(intent);
            }
        });
        ...
        imgEditLeft.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(HomeActivity.this, ProfileEditActivity.class);
                startActivityForResult(intent, 1);
        ...
        if (isInternetPresent) {
            ...
            Referensi.showAlertDialog(HomeActivity.this, "No Internet Connection", "You don't have internet connection.", false);
        }
    }
    ...
    public void getCategori(final JSONArray jArrProduk) {
        String url = Referensi.url+"/getCategori.php";
        JsonObjectRequest jsObjRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    categoryAdapter = new CategoryAdapter(HomeActivity.this, response.getJSONArray("categories"), jArrProduk);
